...
moved {
  from = btp_subaccount_entitlement.feature_flags_dashboard_app_lite
  to   = module.srvc_baseline.btp_subaccount_entitlement.feature_flags_dashboard_app_lite
}
...
moved {
  from = btp_subaccount_subscription.feature_flags_dashboard_app_lite
  to   = module.srvc_baseline.btp_subaccount_subscription.feature_flags_dashboard_app_lite
}